    ...
    <section className="bg-white flex w-full max-w-screen-2xl flex-col overflow-hidden items-stretch justify-center px-20 py-16 max-md:px-5">
      <div className="w-full">
        <div className="w-full">
          ...
          <p className="text-[rgba(34,34,34,1)] text-2xl max-md:text-xl font-normal leading-10 mt-2.5 max-md:max-w-full">
        ...
        <div className="bg-[rgba(249,249,249,1)] relative flex w-full flex-col items-center justify-center mt-[31px] px-20 py-[74px] max-md:px-5 hover:cursor-pointer group">
          ...
          />
          <div className="absolute inset-0 bg-black/5 backdrop-blur-sm group-hover:opacity-100 transition duration-200 md:opacity-0 opacity-100 flex justify-center items-center">
            <div className="relative flex min-w-60 gap-12 flex-col text-[rgba(34,34,34,1)] font-medium text-center leading-loose w-64 rounded-[64px] hover:scale-[1.01]">
