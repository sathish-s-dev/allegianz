...
const Team = () => {
  const teamMembers = [
    {
      image:
        "https://cdn.builder.io/api/v1/image/assets/047e52a986654640b02e58e3fac7be90/421f03ad7aa7f09f3481d8199e5bf5323d330f93?placeholderIfAbsent=true",
      name: "Allen Chelliah James",
      position: "Principle Founder",
    },
    {
      image:
        "https://cdn.builder.io/api/v1/image/assets/047e52a986654640b02e58e3fac7be90/322701774445c32d82c81fd69876af69a123a976?placeholderIfAbsent=true",
      name: "Phani C Kumar",
      position: "Chief Financial Accountant",
    },
    {
      image:
        "https://cdn.builder.io/api/v1/image/assets/047e52a986654640b02e58e3fac7be90/ecc2827de10771cbfd2050105cd369201dacf499?placeholderIfAbsent=true",
  ...
  return (
    <section
      id="team"
      className="bg-white flex min-h-[966px] max-w-full w-[1514px] flex-col items-center justify-center px-[92px] max-md:py-8 py-[83px] max-md:px-5"
    >
      <div className="flex w-full max-w-[1321px] flex-col items-stretch justify-center">
        <div className="w-full md:text-[76px] text-[rgba(34,34,34,1)] font-normal tracking-[-0.84px] leading-[74px] pt-5 pb-[13px] max-md:text-4xl max-md:leading-[44px] max-md:pr-5">
          <h2>
