...
const Header = () => {
  return (
    <header className="bg-white shadow-[0px_4px_30px_rgba(0,0,0,0.05)] w-full px-9 py-4 max-md:px-5">
      <div className="flex w-full items-center gap-[40px_100px] justify-between flex-wrap">
        ...
        <nav className="flex min-w-60 items-center gap-[37px] flex-wrap">
          <div className="flex min-w-60 items-center gap-[40px_41px] text-base text-[rgba(34,34,34,1)] font-medium tracking-[-0.34px] leading-none flex-wrap">
            <a href="#about" className="leading-none w-[70px] hover:text-[rgba(133,82,215,1)] transition-colors">
              About Us
            </a>
            <a href="#expertise" className="text-[17px] w-[111px] hover:text-[rgba(133,82,215,1)] transition-colors">
              Our Expertise
            </a>
            <a href="#approach" className="leading-none w-28 hover:text-[rgba(133,82,215,1)] transition-colors">
              Our Approach
            </a>
            <a href="#testimonials" className="w-[94px] hover:text-[rgba(133,82,215,1)] transition-colors">
              Testimonals
            </a>
            <a href="#team" className="w-[42px] hover:text-[rgba(133,82,215,1)] transition-colors">
              Team
            </a>
          </div>
