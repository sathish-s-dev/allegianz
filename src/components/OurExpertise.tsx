  ...
  const services = [
    {
      ...
      description: "Turn insights into impact. We align your vision with market intelligence, competitive analysis, and long-term growth strategy."
    },
    {
    ...
    },
    {
      ...
      description: "Smarter financial decisions.Get expert support in capital raising, restructuring, investments, and risk management."
    },
    {
      ...
      description: "Funding that fits.Connect with global investors, VCs, and sovereign funds to unlock tailored equity or debt financing"
    },
    {
      ...
      description: "Do more with less.We help streamline operations, eliminate inefficiencies, and drive measurable cost savings."
    },
    {
      ...
      description: "Navigate business challenges.Get expert, external guidance to restructure distressed businesses and preserve long-term value."
    }
  ];

  return (
    <section id="expertise" className="max-w-full w-[1514px]">
      <div className="flex flex-col relative min-h-[856px] w-full overflow-hidden items-center justify-center py-[83px]">
        <img
        ...
        <div className="relative flex h-[691px] w-[1328px] max-w-full items-center gap-4 flex-wrap">
          <div className="flex flex-col shadow-[0px_0px_2px_rgba(0,0,0,0.12)] relative aspect-[0.443] min-w-60 min-h-[720px] gap-2.5 w-[319px] pt-[325px] pb-9 px-[25px] rounded-[25px] max-md:pt-[100px] max-md:px-5">
            <img
            ...
            <div className="relative z-10 min-w-60 w-[266px]">
              ...
              <p className="text-[rgba(220,238,248,1)] text-base font-normal leading-[25px] tracking-[-0.49px] mt-[15px]">
                We tailor our services to your business's unique needs,
                whether you're exploring growth opportunities, facing
                restructuring challenges, or seeking strategic guidance. Our
                expertise includes a wide range of solutions.
              </p>
            </div>
          </div>
          
          <div className="flex min-w-60 items-center gap-[16px] text-[rgba(34,34,34,1)] flex-wrap flex-1 shrink basis-[50px]">
            {services.map((service, index) => (
              <article key={index} className="bg-[rgba(254,254,254,1)] shadow-[0px_0px_2px_rgba(0,0,0,0.12)] border flex min-w-60 min-h-[352px] gap-6 grow shrink w-[255px] pt-6 pb-[79px] px-6 rounded-[25px] border-[rgba(230,242,251,1)] border-solid hover:shadow-lg transition-shadow max-md:px-5">
                <div className="min-w-60 w-[267px]">
                  <img
                    src={service.icon}
