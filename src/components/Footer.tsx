...
const socialIcons = [
    ...
    {
      src: "https://cdn.builder.io/api/v1/image/assets/047e52a986654640b02e58e3fac7be90/6864fa6ba468fb7abe48ecaf7e57f4a0c2deb33a?placeholderIfAbsent=true",
      alt: "Twitter",
    },
    {
      src: "https://cdn.builder.io/api/v1/image/assets/047e52a986654640b02e58e3fac7be90/f37ba4f01b1d18b45516bf0f9b93f121e6a5e0f2?placeholderIfAbsent=true",
      alt: "LinkedIn",
    },
    {
      src: "https://cdn.builder.io/api/v1/image/assets/047e52a986654640b02e58e3fac7be90/5860aebc52f77208d0f8b2c2c9247ad660486c78?placeholderIfAbsent=true",
      alt: "Instagram",
    },
  ];
const Footer = () => {
      ...
      <div className="max-w-screen-2xl mx-auto">
            ...
            <div className="w-[64%] max-md:w-full max-md:ml-0">
              <div className="flex w-full flex-col items-stretch max-md:mt-10">
                ...
                <div className="flex md:items-center flex-col md:flex-row gap-[30px] text-base text-white font-light underline leading-none mt-5">
                  ...
                  <a
                    href="mailto:allegianz@gmail.com"
                    className="flex items-center gap-2.5 whitespace-nowrap w-[214px] hover:text-[rgba(133,82,215,1)] transition-colors"
                  >
                    <img
                    ...
                    />
                    <span className="w-[169px]">allegianz@gmail.com</span>
                  </a>
                </div>
              </div>
            </div>
        ...
        <div className="flex w-full items-stretch gap-[40px_100px] text-[13px] flex-wrap mt-[39px]">
          ...
          <div className="flex items-stretch gap-[27px] text-white font-normal flex-1">
            <a
              href="#"
              className="leading-loose hover:text-[rgba(133,82,215,1)] transition-colors"
            >
              Privacy Policy
            </a>
            <a
              href="#"
              className="leading-[1.7] basis-auto hover:text-[rgba(133,82,215,1)] transition-colors"
            >
              Terms & Conditions
            </a>
          </div>
